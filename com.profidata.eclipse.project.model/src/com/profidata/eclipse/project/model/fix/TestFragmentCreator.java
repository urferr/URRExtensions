	...
	private void createTestProject(IProject theProject, List<IClasspathEntry> theTestSourceClasspathEntries) {
		...
		if (!aProjectWrapper.isExisting()) {
			...
			aProjectWrapper.createProject()
					...
					.addClasspathEntry(
							theTestProject -> JavaCore.newContainerEntry(ProjectConstants.PLUGIN_CLASSPATH));
			...
			aProjectWrapper
					.createTestFragmentManifest(theProject, () -> aAdditionalConfig.additionalPackageDependencies, () -> Collections.emptySet(), Collections.emptyMap())
